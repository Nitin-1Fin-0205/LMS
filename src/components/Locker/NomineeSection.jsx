...
import { fetchNominees } from '../../store/slices/lockerSlice';
...
const NomineeSection = ({
    ...
    const handleSaveNominees = async () => {
        ...
        if (customerId) {
            try {
                const nomineesResponse = await dispatch(fetchNominees(customerId)).unwrap();
                onUpdateNominees(nomineesResponse.data.nominees.map(nominee => ({
                    ...nominee,
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-4 mt-4 shadow-md">
                ...
                <div className="flex items-center justify-between mb-4 pb-3 border-b border-gray-100">
                    ...
                    >
                        ...
                        {nominees?.length > 0 ? 'Update Nominees' : 'Add Nominees'}
                    </button>
                </div>
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between">
                            <p className="text-xs text-gray-600">
                                <span className="font-medium">{nominees.length}</span> nominee{nominees.length !== 1 ? 's' : ''} added
                            </p>
                        </div>
